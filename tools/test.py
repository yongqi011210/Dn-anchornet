...
def parse_args():
    ...
    parser.add_argument('--config', default='../run/oriented_rcnn_r50_fpn_fp16_1x_dota_le90.py',
                        help='train config file path')
    parser.add_argument('--work-dir', default='../run', help='the dir to save logs and models')
    parser.add_argument('--checkpoint', default='../run/epoch_18.pth', help='checkpoint file')
    ...
    parser.add_argument(
        ...
        type=str,
        nargs='+',
        help='评估指标，取决于数据集，例如 COCO 的 "bbox"、"segm"、"proposal"，PASCAL VOC 的 "mAP"、"recall"、"precision"、"f1_score"'
    )
    parser.add_argument('--show', action='store_true', help='show results')
    parser.add_argument('--show-dir',default='../MUL',help='directory where painted images will be saved')
    parser.add_argument(
        '--show-score-thr',
        type=float,
        default=0.5,
